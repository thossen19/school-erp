<?php $__env->startSection('title', 'Attendance Prediction'); ?>
...
<?php $component = App\View\Components\StatsCard::resolve(['icon' => 'fa-percentage','value' => ''.e(number_format($stats->avg_score ?? 0, 1)).'%','title' => 'Average Attendance Prediction','color' => 'info'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="col-md-3">
        <?php if (isset($component)) { $__componentOriginalcdff021ff5f0998733708169e37bbb75 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcdff021ff5f0998733708169e37bbb75 = $attributes; } ?>
<?php $component = App\View\Components\StatsCard::resolve(['icon' => 'fa-calculator','value' => ''.e($stats->total ?? 0).'','title' => 'Total Predictions','color' => 'primary'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('stats-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<div class="card shadow-sm border-0 mb-3">
    <div class="card-body py-2">
        ...
        <div class="collapse mt-2" id="attSearchCollapse">
            <form method="GET" action="<?php echo e(route('ai.attendance-prediction')); ?>" class="row g-2">
                <div class="col-md-3">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <a href="<?php echo e(route('ai.attendance-prediction')); ?>" class="btn btn-sm btn-outline-secondary"><i class="fas fa-times me-1"></i>Clear</a>
                </div>
            </form>
        </div>
    </div>
...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['#','Student','Admission No','Prediction Score','Label','Predicted At'])]); ?>
            ...
            <tr>
                ...
                <td class="fw-semibold"><?php echo e(trim(($p->first_name ?? '') . ' ' . ($p->last_name ?? '')) ?: '-'); ?></td>
                <td><?php echo e($p->admission_no ?? '-'); ?></td>
                <td>
                    <span class="badge bg-<?php echo e(($p->prediction_score ?? 0) >= 70 ? 'success' : (($p->prediction_score ?? 0) >= 40 ? 'warning' : 'danger')); ?>">
                        <?php echo e($p->prediction_score ?? 0); ?>%
                    </span>
                </td>
                <td><?php echo e($p->prediction_label ?? '-'); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\aischool\resources\views/ai/attendance-prediction.blade.php ENDPATH**/ ?>