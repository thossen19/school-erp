...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', config('app.name', 'School ERP')); ?> - <?php echo e(config('app.name', 'School ERP')); ?></title>
...
<body>
    ...
    <aside class="bg-sidebar" id="sidebar">
        <div class="sidebar-header">
            <span class="logo-text"><i class="fas fa-graduation-cap me-2"></i><?php echo e($schoolShortCode ?? 'School'); ?></span>
    ...
    <div class="main-content" id="mainContent">
        <nav class="top-navbar">
            ...
            <div class="navbar-brand-mobile fw-bold">
                <i class="fas fa-graduation-cap me-2"></i><?php echo e($schoolShortCode ?? 'School'); ?>
            ...
            <div class="ms-auto d-flex align-items-center gap-2">
                <button class="btn btn-sm btn-outline-secondary position-relative" data-bs-toggle="dropdown" id="notificationBell">
                    ...
                    <?php if($unreadCount > 0): ?>
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"><?php echo e($unreadCount); ?></span>
                    <?php endif; ?>
                </button>
                <div class="dropdown-menu dropdown-menu-end notification-dropdown" style="min-width:320px">
                    <h6 class="dropdown-header d-flex justify-content-between align-items-center">
                        ...
                        <?php if($unreadCount > 0): ?>
                            <form method="POST" action="<?php echo e(route_if_exists('notifications.markAllRead')); ?>" class="d-inline">
                                <?php echo csrf_field(); ?>
                    ...
                    <div style="max-height:350px;overflow-y:auto">
                        <?php $__empty_1 = true; $__currentLoopData = $recentNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php $data = $notif->data; ?>
                            <a class="dropdown-item <?php echo e($notif->read_at ? '' : 'bg-light'); ?>" href="<?php echo e(!empty($data['url']) ? $data['url'] : '#'); ?>">
                                <div class="d-flex align-items-center gap-2">
                                    <i class="fas <?php echo e($data['icon'] ?? 'fa-bell'); ?> text-<?php echo e($data['color'] ?? 'primary'); ?>"></i>
                                    <div>
                                        <small class="fw-semibold d-block"><?php echo e($data['title'] ?? class_basename($notif->type)); ?></small>
                    ...
                    <a class="dropdown-item text-center" href="<?php echo e(route_if_exists('notifications.index')); ?>">
                ...
                <div class="dropdown">
                    <a href="#" class="text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
                        <div class="d-flex align-items-center gap-2">
                            <div class="avatar-circle"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></div>
                            <span class="d-none d-md-inline text-body"><?php echo e(Auth::user()->name); ?></span>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="<?php echo e(route_if_exists('profile.show')); ?>"><i class="fas fa-user me-2"></i>Profile</a></li>
...
</html><?php /**PATH C:\Users\Lupu\Desktop\laravel\aischool\resources\views/layouts/app.blade.php ENDPATH**/ ?>