...
<head>
    ...
    <title><?php echo e(config('app.name', 'School')); ?> - What Starts Here Changes Everything</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700;900&family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <style>
        <?php echo $__env->make('partials.homepage-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<body>
    ...
    <?php echo $__env->make('partials.homepage-header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('partials.public-breadcrumb', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="container hero-content">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <p class="hero-sub">
                        At <?php echo e(config('app.name', 'AISchool')); ?>, we nurture minds, spark curiosity, and build tomorrow's leaders. 
        ...
        <div class="container">
            <div class="split-section">
                <div class="col-lg-6 content">
                    <h2>The <?php echo e(config('app.name', 'AISchool')); ?> Experience</h2>
                    <p>
                        A better way, a better outcome, a better world. The <?php echo e(config('app.name', 'AISchool')); ?> experience reflects 
    ...
    <div class="cta-banner">
        <div class="container">
            <h2>For <?php echo e(config('app.name', 'Our Community')); ?>,<br>For the Future</h2>
            <p>
    ...
    <?php echo $__env->make('partials.homepage-footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html><?php /**PATH C:\Users\Lupu\Desktop\laravel\aischool\resources\views/welcome.blade.php ENDPATH**/ ?>