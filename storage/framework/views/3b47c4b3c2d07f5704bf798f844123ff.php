<?php $__env->startSection('title', 'Fee Defaulter Prediction'); ?>
...
<?php $component = App\View\Components\StatsCard::resolve(['icon' => 'fa-exclamation-triangle','value' => ''.e(number_format($stats->avg_score ?? 0, 1)).'%','title' => 'Avg Risk Score','color' => 'danger'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<div class="card shadow-sm border-0 mb-3">
    <div class="card-body py-2">
        ...
        <div class="collapse mt-2" id="feeSearchCollapse">
            <form method="GET" action="<?php echo e(route('ai.fee-defaulter-prediction')); ?>" class="row g-2">
                <div class="col-md-3">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <a href="<?php echo e(route('ai.fee-defaulter-prediction')); ?>" class="btn btn-sm btn-outline-secondary"><i class="fas fa-times me-1"></i>Clear</a>
                </div>
            </form>
        </div>
    </div>
...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['#','Student','Admission No','Prediction Score','Label','Predicted At'])]); ?>
            ...
            <?php $score = $p->prediction_score ?? 0; $badgeColor = $score > 70 ? 'danger' : ($score >= 40 ? 'warning' : 'success'); ?>
            <tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lupu\Desktop\laravel\aischool\resources\views/ai/fee-defaulter-prediction.blade.php ENDPATH**/ ?>