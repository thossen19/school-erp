...
<div class="flex justify-between items-center mb-4">
    ...
    <a href="{{ route('attendance.index') }}" class="px-3 py-1 bg-gray-600 text-white text-sm rounded hover:bg-gray-700">Back</a>
</div>
<div class="bg-white rounded shadow p-4">
    <form method="POST" action="{{ route('attendance.store') }}" class="space-y-4">
        @csrf
        <p class="text-gray-500">Bulk attendance marking form goes here.</p>
