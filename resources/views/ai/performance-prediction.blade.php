@extends('layouts.app')
@section('title', 'Student Performance Prediction')
@section('content')
...
<div class="row g-3 mb-3">
    <div class="col-md-3">
        <x-stats-card icon="fa-chart-simple" value="{{ number_format($stats->avg_score ?? 0, 1) }}%" title="Average Score" color="primary" />
    </div>
    <div class="col-md-3">
        <x-stats-card icon="fa-calculator" value="{{ $stats->total ?? 0 }}" title="Total Predictions" color="info" />
    </div>
</div>
...
<div class="card shadow-sm border-0 mb-3">
    <div class="card-body py-2">
        ...
        <div class="collapse mt-2" id="perfSearchCollapse">
            <form method="GET" action="{{ route('ai.performance-prediction') }}" class="row g-2">
                <div class="col-md-3">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <a href="{{ route('ai.performance-prediction') }}" class="btn btn-sm btn-outline-secondary"><i class="fas fa-times me-1"></i>Clear</a>
                </div>
            </form>
        </div>
    </div>
